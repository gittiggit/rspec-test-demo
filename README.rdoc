...
Step 11: deleting article feature test
         a. create spec/features/deleting_article_path
         b. Add the codes
...
Run the guard. Shows an error. To fix this add the link with text "Delete" in the views/articles/show.html.erb
...
Step 12: Update the styling of the edit and destroy link
      class:"btn btn-primary btn-lg btn-space"
      class:"btn btn-danger btn-lg btn-space"


Step 13: Refactor article controller and edit, new page

===========================================================================================================
*** Completed - Articles with feature tests
Now to implement
  - Users Sign-up
  - Log in.Log out
  - Restrict access to certain features

Step 14: setup devise
     a. gem "devise"
     => bundle install
     b. install devise in the app
     => rails g devise:install
It will add locals/devise.rb and initializers/devise.rb file to the application

========================================================================================================

Step 15: User Model
        a. => rails g devise User
           => rake db:migrate
        b. rake routes | grep devise   # to see all the routes for devise


Step 16: Create feature spec for users sign up
         spec/features/signing_users_up_spec.rb
...
Run the test, and will show
      Failure/Error: click_link "Sign up"
      Capybara::ElementNotFound:
      Unable to find link "Sign up"

** Add the sign up link to application.html.erb
...
Step 17: Styling devise views

       a. => rails g devise:views
       b. design the views/devise/registration/new.html.erb like as follows

   <h2 class="text-cnter">Sign up</h2>
   <div class="row">
     <div class="col-md-12">
     </div>
   </div>
   <%= form_for(resource, as: resource_name, html: {class: "form-horinzontal", role: "form"},
...
Step 18: Users sign in feature test
        a. create spec/features/signing_users_in_spec.rb
        b. Add the link to header
